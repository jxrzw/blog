...
class Article(models.Model):
    ...
    image = models.ImageField(upload_to='uploads/article/%Y/%m/%d', verbose_name='文章图片',default='uploads/article/2020/04/25/t02.jpg')
...
class Comment(models.Model):
    ...
    content = models.TextField(verbose_name='内容')
    date = models.DateField(auto_now=True,verbose_name='评论时间')
...
class Message(models.Model):
    ...
    icon = models.CharField(max_length=50,verbose_name='头像',default='images/tx1.jpg')
